...
public class SiriRepeaterMain {
  ...
  private void printUsage() {
    ...
    System.err.println("  -" + ARG_ID + "=id                          the SIRI participant id used by your client and server");
    System.err.println("  -" + ARG_CLIENT_URL + "=url                  the url your repeater client binds to and uses in publish/subscribe with your SIRI source");
    System.err.println("  -" + ARG_PRIVATE_CLIENT_URL + "=url           the internal url your repeater client will actually bind to, if specifed (default=clientUrl)");    
    System.err.println("  -" + ARG_REPEATER_URL + "=url                the url your repeater server binds to and listens to incoming client requests");
    System.err.println("  -" + ARG_PRIVATE_REPEATER_URL + "=url         the internal url your repeater server will actually bind to, if specified (default=repeaterUrl)");
    System.err.println("  -" + ARG_DATA_SOURCE + "=path                a Spring context.xml file containing additional bean defs");
    System.err.println();
